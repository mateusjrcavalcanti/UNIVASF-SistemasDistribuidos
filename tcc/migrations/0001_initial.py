...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avaliacao', models.FileField(blank=True, null=True, upload_to=tcc.models.avaliacao.get_file_path_avaliacao)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avaliacoesresult', models.ManyToManyField(blank=True, related_name='avaliacoesresult', to='tcc.avaliacao')),
                ...
                ('horario', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tcc.horario')),
                ('resultado', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tcc.resultado')),
                ('trabalho', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='tcc.trabalho')),
            ],
        ),
    ]
